  ...
  return (
    <div className={styles.footer}>
      <div className={styles.left}>
        ...
        <p>09-11-90-92-59</p>
        <p>09-16-05-43-36</p>
        <p>dentalasfaw@gmail.com</p>
      </div>
      <div className={styles.middle}>
        <h2>About Us</h2>
        <p>
          Abay Specialty Dental Clinic is an exceptional dental clinic in
          Hawassa, with a team of certified professionals, an Orthodntist, a
          Maxillofacial Surgeon, Multiple assistants, and dental technicians who
          are passionate about the science and art of dentistry.
        </p>
      </div>
